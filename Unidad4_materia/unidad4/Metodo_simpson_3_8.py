...
class Metodo_simpson_3_8():
    ...
    def proceso(self, expresion,valor_a, valor_b):
        #realiza el proceso de de integracion de metodo simpson 3/8
        ...
        f_X3 = self.f(expresion, X3)
        

        aproximacion = (3*h/8)* (f_X0 + 3*f_X1 + 3*f_X2 + f_X3)
